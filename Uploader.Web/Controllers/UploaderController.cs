  ...
  public class UploaderController : Controller
  {
    ...
    public async Task<IActionResult> UploadVideo(string videoEncodingFormats = null, bool? sprite = null)
    {
      try
      {
        ...
        {
          success = true,
          token = VideoManager.ComputeVideo(await GetFileToTemp(), videoEncodingFormats, sprite)
        });
      }
      catch (Exception ex)
      {
    ...
    public async Task<IActionResult> UploadImage()
    {
      try
      {
        ...
        {
          success = true,
          token = ImageManager.ComputeImage(await GetFileToTemp())
        });
      }
      catch (Exception ex)
      {
    ...
    public async Task<IActionResult> UploadSubtitle(string subtitle)
    {
      try
      {
        ...
        {
          success = true,
          token = await SubtitleManager.ComputeSubtitle(subtitle)
        });
      }
      catch (Exception ex)
      {
